...
<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            <div class="card-body">
                <form action="{{ route('pendapatan.store') }}" method="POST" id="pendapatanForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="month" name="bulan" class="form-control @error('bulan') is-invalid @enderror" value="{{ old('bulan') }}">
                            @error('bulan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="brutoFormatted" class="form-control @error('nilai_bruto') is-invalid @enderror" value="{{ old('nilai_bruto') }}">
                            <input type="hidden" name="nilai_bruto" id="bruto" value="{{ old('nilai_bruto') }}">
                            @error('nilai_bruto')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="pajakFormatted" class="form-control @error('pajak') is-invalid @enderror" value="{{ old('pajak') }}">
                            <input type="hidden" name="pajak" id="pajak" value="{{ old('pajak') }}">
                            @error('pajak')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="potonganFormatted" class="form-control @error('potongan') is-invalid @enderror" value="{{ old('potongan') }}">
                            <input type="hidden" name="potongan" id="potongan" value="{{ old('potongan') }}">
                            @error('potongan')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="nilai_netto" id="netto">
                            @error('nilai_netto')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
...
<script>
    ...
    // Auto hitung netto saat load jika ada nilai lama
    window.addEventListener('load', updateNetto);
</script>
@endsection
